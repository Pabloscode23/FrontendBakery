...
export const ComponentProductCard: React.FC<ProductCardProps> = ({ image, title, description, price }) => {
    return (
        <div className='product-card__container flex flex-row h-[150px] w-[370px] rounded-md overflow-hidden bg-[var(--color-brown-light)] text-[30px]'>
            ...
            <div className='product-card__info-container w-[60%] flex flex-col justify-between pt-3 pb-4 pr-3 pl-[15px]'>
