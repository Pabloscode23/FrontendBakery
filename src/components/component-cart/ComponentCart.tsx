  ...
  return (
    <div className="cart__container flex flex-col w-[300px] h-[400px] rounded-lg p-6 bg-white shadow-lg sticky top-4 mr-5">
        ...
        {items.map((item) => (
          <div key={item.id} className="flex flex-col mb-4 pb-4 border-b">
            <div className="flex justify-between items-start mb-2">
              ...
              >
                        <img src={TrashIcon} alt="Eliminar" className="cursor-pointer w-5 h-5" />
              </button>
            </div>
      ...
      <div className="mt-4 pt-4 border-t">
        ...
        <button onClick={handleToggleModal} className="cursor-pointer mt-4 w-full py-2 bg-[var(--color-brown-middle)] hover:bg-[var(--color-brown-dark)] text-white rounded-lg transition-colors">
          Proceder al Pago
        </button>
        {isNotAuthenticated && (
